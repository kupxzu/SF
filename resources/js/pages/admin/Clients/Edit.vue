...
// Flag to prevent auto-update during initial load
...
onMounted(async () => {
    ...
    try {
        ...
        // Allow address updates after regions are loaded
        setTimeout(() => {
            ...
            <div class="rounded-lg border bg-white p-8">
                <form @submit.prevent="submit" class="space-y-6 max-w-2xl">
                    ...
                    <div class="space-y-4 border-t pt-6">
                        ...
                        <p class="text-sm text-muted-foreground">Current: {{ props.client.address }}</p>
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                type="text"
                                placeholder="Address will be updated when you select location"
                            />
                            <p class="text-xs text-muted-foreground">Select location above to generate new address, or edit directly</p>
